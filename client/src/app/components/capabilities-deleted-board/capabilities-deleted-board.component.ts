...
@Component({
  selector: 'app-deleted-capabilities-board',
  templateUrl: './capabilities-deleted-board.component.html',
  styleUrls: ['./capabilities-deleted-board.component.scss']
})
export class CapabilitiesDeletedBoardComponent implements OnInit {
  ...
  fetchCapabilites() {
    this.capabilityService.getCapabilities().subscribe((capabilities: Capability[]) => {
      ...
      this.capabilitiesLoaded.emit(capabilities);
