...
@Component({
  selector: 'app-create-capabilities-form',
  templateUrl: './create-capabilities-form.component.html',
  styleUrls: ['./create-capabilities-form.component.scss'],
  animations: [
    // trigger('slide-in', [
    //   transition('void => *', [
...
export class CreateCapabilitiesFormComponent implements OnInit {
    ...
    this.forms = {
      capability: this.fb.group({
        name: new FormControl('', {
          updateOn: 'blur',
          //asyncValidators: [this.validateCapabilityName.bind(this)],
  ...
  handleSubmit() {
    ...
    if (valid) {
      let createdCapabilityObservable = this.capabilityService.createCapability(data);

      createdCapabilityObservable.subscribe((createdCapability: CreatedCapability) => {
